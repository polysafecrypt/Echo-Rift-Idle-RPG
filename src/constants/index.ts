...
export const PRESTIGE = {
  ...
  // Stat bonus: +10% per tier (linear), applied to ATK/HP/DEF/DEX/CRIT
  statBonusPct: (tier: number): number => tier * 10,
...
export const CLASS_INFO = {
  vanguard: {
    ...
    bonuses: ['+12% HP', '+10% DEF', '+10 CRIT RES', '-5% ATK'],
    color: '#F97316',
    icon: '🛡️',
  },
  riftmage: {
    ...
    bonuses: ['+18% ATK', '+10 CRIT', '-4% HP', '-5% DEF'],
    color: '#00FF88',
    icon: '⚡',
  },
  phantom: {
    ...
    bonuses: ['+15% DEX', '+10% DODGE', '+25 CRIT DMG', '+12 CRIT', '-3% HP', '-10% DEF'],
    color: '#A855F7',
    icon: '👁️',
  },
} as const
