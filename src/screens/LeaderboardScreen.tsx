...
export default function LeaderboardScreen({ navigation }: any) {
  ...
  const getStatValue = (item: any) => {
    switch (activeTab) {
      ...
      case 'experience':  return `✨ ${item.total_xp?.toLocaleString()} XP`
          ...
          <View style={styles.myRankRow}>
            ...
            <View style={{ flex: 1 }}>
              ...
              <Text style={styles.myRankSub}>
                ...
                {(data.player.prestige_tier ?? 0) > 0 ? ` • T${data.player.prestige_tier}` : ''}
              </Text>
            </View>
          ...
          <View style={[styles.rankRow, item.player_id === userId && styles.rankRowMine]}>
            ...
            <View style={{ flex: 1 }}>
              ...
              <View style={{ flexDirection: 'row', gap: 8, marginTop: 2, alignItems: 'center' }}>
                ...
                {(item.prestige_tier ?? 0) > 0 && (
                  <Text style={styles.tierBadge}>T{item.prestige_tier}</Text>
                )}
              </View>
            </View>
